...
module.exports = {
  config: {
    ...
    uiFontFamily: '"Hack Nerd Font", "DejaVu Sans Mono", Consolas, "Lucida Console", monospace',
    ...
    hypercwd: {
      initialWorkingDirectory: "~/Projects/reps/www/konami.reps"
    },
    ...
    hyperBorder: {
      ...
      //blurredAdminColors: ['random', 'random'],
      //animate: {
      //  duration: '1s',
      //},
      animate: true,
    ...
    backgroundImage: "/Users/mattogram/Pictures/b5b82e51-3bd0-4f6e-8753-abf39c9c6d88.jpeg",
